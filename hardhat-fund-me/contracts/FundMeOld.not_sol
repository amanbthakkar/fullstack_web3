// this is FundMe.sol but with comments from the remix version
// FundMe.sol new is cleaned up
...
import "./PriceConverterOld.sol";

contract FundMe {
    using PriceConverterOld for uint256;
    ...
    constructor() {
        //sets the deployer address as owner of contract
        owner = msg.sender;
    }
